...
public final class PrefixCommand implements CommandExecutor, TabCompleter {
    ...
    public PrefixCommand(PrefixManager prefixManager, PrefixMenuService menuService) {
    ...
    private TagSegment findSegment(String input) {
        ...
        return segment != null && segment.isEditable() && segment.getSide() == SegmentSide.PREFIX ? segment : null;
    }

    private List<String> segmentIds() {
        List<String> ids = new ArrayList<String>();
        for (TagSegment segment : this.prefixManager.getEditableSegments(SegmentSide.PREFIX)) {
